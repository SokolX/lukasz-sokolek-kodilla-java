...
public class CruddAppTestSuite {
    ...
    private static final String BASE_URL = "${APP_URL}";
    public static final String TRELLO_LOGIN = "${TRELLO_LOGIN}";
    public static final String TRELLO_PASSWORD = "${TRELLO_PASSWORD}";
    ...
    @Test
    public void sendTestTaskToTrello() throws InterruptedException {
        String taskName = createCrudAppTestTask();
        sendTestTaskToTrello(taskName);
    }
